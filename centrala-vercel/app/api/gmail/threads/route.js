...
import { trashThread, isAuthenticated } from '../../../../lib/gmail';
import { initDatabase, deleteGmailThread } from '../../../../lib/db';
  ...
  try {
    ...
    for (const threadId of threadIds) {
      try {
        ...
        await deleteGmailThread(threadId);
    ...
    console.error('Delete Gmail threads error:', error);
    return NextResponse.json(
