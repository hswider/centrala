...
import { getThreadsList, getThread, isAuthenticated, parseMessage } from '../../../../lib/gmail-poomfurniture';
import {
  initDatabase,
  saveGmailPoomfurnitureThread,
  saveGmailPoomfurnitureMessage,
  updateGmailPoomfurnitureSyncStatus,
  setGmailPoomfurnitureSyncInProgress,
...
async function handleSync(request) {
  try {
    ...
    await setGmailPoomfurnitureSyncInProgress(true);
    ...
    try {
      ...
      await updateGmailPoomfurnitureSyncStatus();
      await setGmailPoomfurnitureSyncInProgress(false);
    ...
    console.error('Gmail POOMFURNITURE sync error:', error);
    return NextResponse.json(
