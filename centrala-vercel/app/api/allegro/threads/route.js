...
import { isAuthenticated } from '../../../../lib/allegro';
import { initDatabase, deleteAllegroThread } from '../../../../lib/db';
  ...
  try {
    ...
    for (const threadId of threadIds) {
      try {
        ...
        await deleteAllegroThread(threadId);
    ...
    console.error('Delete Allegro threads error:', error);
    return NextResponse.json(
