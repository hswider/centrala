...
import { trashThread, isAuthenticated } from '../../../../lib/gmail-poomkids';
import { initDatabase, deleteGmailPoomkidsThread } from '../../../../lib/db';
  ...
  try {
    ...
    for (const threadId of threadIds) {
      try {
        ...
        await deleteGmailPoomkidsThread(threadId);
    ...
    console.error('Delete Gmail POOMKIDS threads error:', error);
    return NextResponse.json(
