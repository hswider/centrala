...
import { getThreadsList, getThread, isAuthenticated, parseMessage } from '../../../../lib/gmail-poomkids';
import {
  initDatabase,
  saveGmailPoomkidsThread,
  saveGmailPoomkidsMessage,
  updateGmailPoomkidsSyncStatus,
  setGmailPoomkidsSyncInProgress,
...
async function handleSync(request) {
  try {
    ...
    await setGmailPoomkidsSyncInProgress(true);
    ...
    try {
      ...
      await updateGmailPoomkidsSyncStatus();
      await setGmailPoomkidsSyncInProgress(false);
    ...
    console.error('Gmail POOMKIDS sync error:', error);
    return NextResponse.json(
