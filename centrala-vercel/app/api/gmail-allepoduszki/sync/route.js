...
import { getThreadsList, getThread, isAuthenticated, parseMessage } from '../../../../lib/gmail-allepoduszki';
import {
  initDatabase,
  saveGmailAllepoduszkiThread,
  saveGmailAllepoduszkiMessage,
  updateGmailAllepoduszkiSyncStatus,
  setGmailAllepoduszkiSyncInProgress,
...
async function handleSync(request) {
  try {
    ...
    await setGmailAllepoduszkiSyncInProgress(true);
    ...
    try {
      ...
      await updateGmailAllepoduszkiSyncStatus();
      await setGmailAllepoduszkiSyncInProgress(false);
    ...
    console.error('Gmail ALLEPODUSZKI sync error:', error);
    return NextResponse.json(
