  ...
  try {
    ...
    for (const item of items) {
      try {
        ...
        await sql`
          INSERT INTO inventory (sku, nazwa, ean, stan, cena, czas_produkcji, kategoria)
          VALUES (${item.sku}, ${item.nazwa}, ${item.ean || null}, ${item.stan || 0}, ${item.cena || 0}, ${item.czas_produkcji || 0}, ${kategoria})
