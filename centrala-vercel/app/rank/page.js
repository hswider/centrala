    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      <main className="max-w-7xl mx-auto px-3 py-4 sm:px-6 sm:py-6 lg:px-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">TOP 100 produktów z ostatnich 30 dni</p>
        </div>
          ...
          {stats?.topProducts?.length > 0 && (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900">
              <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                <h2 className="font-semibold text-gray-900 dark:text-white">TOP {stats.topProducts.length} produktów</h2>
              </div>
