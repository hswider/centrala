              ...
              <div className="overflow-x-auto">
                ...
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-2 py-3 text-left text-[10px] sm:text-xs font-medium text-gray-500 uppercase min-w-[150px] sticky left-[40px] bg-gray-50 z-20 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)]">Nazwa produktu</th>
                  ...
                  {currentItems.length === 0 ? (
                    ...
                    currentItems.map((item) => (
                      <tr key={item.id} className={`hover:bg-gray-50 ${selectedIds.has(item.id) ? 'bg-blue-50' : ''}`}>
                        ...
                        <td className={`px-2 py-2 text-xs sm:text-sm text-gray-700 min-w-[150px] sticky left-[40px] z-10 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] ${selectedIds.has(item.id) ? 'bg-blue-50' : 'bg-white'}`}>{item.nazwa}</td>
