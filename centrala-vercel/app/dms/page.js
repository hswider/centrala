...
export default function DMSPage() {
  ...
  const [activeTab, setActiveTab] = useState('search'); // 'search' | 'invoice'
    ...
    printWindow.document.write(`
      ...
      <body>
        <div class="invoice-header">
          ...
          <div>
            <div class="logo">🛋️ gutekissen®</div>
          </div>
        </div>
        ...
        <div class="invoice-meta">
          <div class="meta-item">
            <div class="meta-label">Rechnungsnr.</div>
            <div class="meta-value">${invoice.invoiceNumber}</div>
          </div>
          <div class="meta-item">
            <div class="meta-label">Datum</div>
            <div class="meta-value">${formatDateDE(invoice.invoiceDate)}</div>
          </div>
          <div class="meta-item">
            <div class="meta-label">Zahlungsbedingungen</div>
            <div class="meta-value">${invoice.paymentTerms}</div>
          </div>
        </div>
          ...
          <tbody>
            ${invoice.items.map(item => `
              <tr>
                ...
                <td class="amount">${formatCurrency(item.total, invoice.currency)}</td>
              </tr>
            `).join('')}
          </tbody>
        </table>
        ...
        <div class="totals">
          ...
          <div class="total-row">
            ...
            <span>inkl. ${formatCurrency(invoice.taxAmount, invoice.currency)}</span>
          </div>
        ...
        <div class="footer">
          GuteKissen • ${invoice.sellerAddress} • ${invoice.sellerEmail}
        </div>
      </body>
      </html>
    `);
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      <main className="max-w-7xl mx-auto px-3 py-4 sm:px-6 sm:py-6 lg:px-8">
        ...
        <div className="flex gap-2 mb-4">
          ...
          >
            <img src="/icons/gutekissen.png" alt="GuteKissen" className="w-5 h-5 rounded-full" />
            Rechnung GuteKissen
          </button>
        </div>
                    ...
                    {orders.map((order) => (
                      <div
                        ...
                        className={`p-4 cursor-pointer transition-colors hover:bg-green-50 dark:hover:bg-green-900/20 ${
                          selectedOrder?.id === order.id ? 'bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500' : ''
                        }`}
                      >
                        <div className="flex items-start gap-3">
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-500 dark:text-gray-400">
                              <span>
                                <strong>Klient:</strong> {order.customer?.name || order.shipping?.name || '-'}
                              </span>
                              <span>
                                <strong>Data:</strong> {formatDatePL(order.dates?.orderedAt)}
                              </span>
                              <span>
            ...
            {!searched && (
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900 p-8 text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                  Wyszukaj zamowienia z modulu OMS, kliknij wybrane zamowienie i wygeneruj fakture.
                </p>
              </div>
            )}
          </>
              ...
              <div ref={invoiceRef}>
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateInvoiceField('sellerName', e.target.value)}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateInvoiceField('sellerEmail', e.target.value)}
                          className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateInvoiceField('sellerAddress', e.target.value)}
                          className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateInvoiceField('sellerTaxId', e.target.value)}
                          className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateInvoiceField('buyerEmail', e.target.value)}
                          placeholder="name@kunde.com"
                          className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                        />
                      </div>
                      <div>
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                      onClick={addItem}
                      className="px-3 py-1 text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-900/50"
                    >
                      + Hinzufügen
                    </button>
                  </div>
                  ...
                  {invoice.items.length === 0 && (
                    <div className="text-center py-8 text-gray-500 dark:text-gray-400 text-sm">
                      Keine Positionen. Wählen Sie eine Bestellung aus oder fügen Sie Positionen hinzu.
                    </div>
                  )}
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    placeholder="Hinweise – alle relevanten Informationen, die nicht abgedeckt sind, zusätzliche Geschäftsbedingungen"
                    className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                  />
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              {selectedOrder && (
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900 p-4">
                  <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Ausgewählte Bestellung</h3>
                  <div className="space-y-2 text-xs">
                    <div className="flex justify-between">
                      <span className="text-gray-500 dark:text-gray-400">Bestellnr.</span>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900 dark:text-white">{formatDateDE(selectedOrder.dates?.orderedAt)}</span>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <button
                    onClick={() => setActiveTab('search')}
                    className="w-full mt-3 px-3 py-2 text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600"
                  >
              ...
              {/* Tax Settings */}
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900 p-4">
                <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Steuer</h3>
                <div className="space-y-3">
                  <div>
                    <label className="block text-xs text-gray-500 dark:text-gray-400 mb-1">MwSt.-Satz</label>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-600 dark:text-gray-400">Inklusive MwSt.</span>
                  </div>
                </div>
              </div>
              ...
              {/* Currency */}
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900 p-4">
                <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Währung</h3>
                <select
              ...
              {/* Actions */}
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-900 p-4">
                <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Aktionen</h3>
                <div className="space-y-2">
                  <button
                    onClick={generatePDF}
                    className="w-full px-4 py-2 text-sm font-medium bg-green-600 text-white rounded-lg hover:bg-green-700"
                  >
                    PDF herunterladen
                  </button>
                </div>
